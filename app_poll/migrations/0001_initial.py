    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_question', models.CharField(choices=[('text', 'Ввод ответа текстом'), ('one_choice', 'Ответ с выбором одного варианта'), ('some_choices', 'Ответ с выбором нескольких вариантов')], max_length=50, verbose_name='Тип вопроса')),
